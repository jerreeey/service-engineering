 ...
 * 
 */
@WebServiceClient(name = "WebService1", targetNamespace = "http://tempuri.org/", wsdlLocation = "https://currencyconvertercarrental.azurewebsites.net/CurrencyConverterWS.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://currencyconvertercarrental.azurewebsites.net/CurrencyConverterWS.asmx?wsdl");
